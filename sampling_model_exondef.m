...
load('randomparameters_lhs10000exondefinition.mat');%load the random parameters from latin hypercube sampling
% random_param=random_param(:,1:15);%for exon definition have 2 parameters less than intron definition
